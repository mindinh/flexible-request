 ...
 */
service RequestService @(path: '/browse', impl: './request-service') {
    ...
    @readonly
    entity StepDefinitions as projection on db.StepDefinitions {
        *,
    ...
    entity AvailableRequestTypes as projection on db.RequestTypes {
    ...
    entity Steps as projection on db.Steps {
        *,
    ...
    entity StepApprovals as projection on db.StepApprovals {
        *,
    ...
    @readonly entity RequestHistory as projection on db.RequestHistory;
    @readonly entity StepHistory as projection on db.StepHistory;
    ...
    @readonly entity ApproverRules as projection on db.ApproverRules {
        *,
        virtual null as principalDisplayName : String
    };

    // Organization Data (ReadOnly for Lookup)
    @readonly entity ShadowUsers as projection on db.ShadowUsers;
    @readonly entity ShadowGroups as projection on db.ShadowGroups;
    @readonly entity SupportTypes as projection on db.SupportTypes;
